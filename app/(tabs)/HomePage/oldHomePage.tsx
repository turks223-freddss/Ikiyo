    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      >
        ...
        <View>
          ...
          <Text style={styles.userId}>{user ? user.userID : "Loading..."}</Text>
        </View>
      </Pressable>
      ...
      <View style={styles.statusContainer}>
        ...
        <View style={styles.statusRow}>
          <Ionicons name="cash-outline" size={40} color="gold" style={styles.iconMargin} />
          <Text style={styles.statusText}>{userData?.gold}</Text>
        </View>

        {/* Second Row: Heart Icon + Number */}
        <View style={styles.statusRow}>
          <Ionicons name="heart-outline" size={40} color="red" style={styles.iconMargin} />
          <Text style={styles.statusText}>522</Text>
        </View>
      </View>
